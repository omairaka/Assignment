...
let items:string[]=["Mortein","Nestle Water ","Sugar","Yogurt"];
let app:string[]=["Banana"];
...
//Sixth Question
var arr:number[]=[-1,5,8,2,3,-8,6,4,10];
...
//Eighth Question
var celcius:number[]=[25,89,34,4]
var i=0;
var fahrenheit_array:number[]=[];
